...
describe('generated project-owned polish checker', () => {
  ...
  test('generated 3d checker rejects a skin attached without vertex skinning attributes', async () => {
    const current = fixture('3d', true)
